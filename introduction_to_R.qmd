...
Things to add, after the meeting on 30 June

-   Some basic stats analyses, e.g. a chi-square test and t-test.

-   A basic description of what R is used for, and of what other things are better for (doing algebra, plotting graphs). Matlab, Desmos.

-   Explain the use of quotes for text.

-   Change the focus a bit... the workshop isn't just for social scientists.

-   Talk about datasets that come with R packages.
...
I have put the CSV file on a webpage [here](https://github.com/jimstankovich/stats-and-R/blob/main/asean_data.csv).
...
To plot the graphs from now on, you need to download a much bigger CSV file of Gapminder data, called `big_gapminder_dataset.csv`. It is available [here](https://github.com/jimstankovich/stats-and-R/blob/main/big_gapminder_dataset.csv).
...
# This palette is recommended for people who are colour-blind
...
Apart from the sources mentioned in @sec-about, another excellent place to learn more about R is the free online book [R for Data Science (2nd edition)](https://r4ds.hadley.nz/), by Hadley Wickham, Mine Çetinkaya-Rundel and Garrett Grolemund.
